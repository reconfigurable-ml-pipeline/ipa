...
folders=(
    /mnt/myshareddir/huggingface/text-classification/dinalzein-xlm-roberta-base-finetuned-language-identification
)
...
IMAGE_NAME=nlp-centralized-with-model:nlpli
