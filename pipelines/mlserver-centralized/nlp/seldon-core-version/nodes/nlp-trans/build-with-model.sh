...
folders=(
    /mnt/myshareddir/huggingface/translation_fr_to_en/Helsinki-NLP-opus-mt-fr-en
    /mnt/myshareddir/huggingface/translation_fr_to_en/Helsinki-NLP-opus-mt-tc-big-fr-en
)
...
IMAGE_NAME=nlp-centralized-with-model:nlptrans
