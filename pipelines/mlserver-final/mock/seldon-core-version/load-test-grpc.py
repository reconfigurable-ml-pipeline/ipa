...
# ax.grid()
# fig.savefig(f"{platform}_variant_{variant}-sending_time-load-{load}-test_duration-{test_duration}.png")
# plt.show()
...
# ax.grid()
# fig.savefig(f"{platform}_variant_{variant}-server_arrival_time_from_start-load-{load}-test_duration-{test_duration}.png")
# plt.show()
...
# ax.grid()
# fig.savefig(f"{platform}-load-{load}-test_duration-{test_duration}.png")
# plt.show()
